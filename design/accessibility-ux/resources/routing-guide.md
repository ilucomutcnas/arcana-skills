...
- Open `examples/skills/<slug>.md` for realistic workflows and deliverable formats.
- If a task spans multiple concerns, compose relevant mini-skills instead of collapsing workflows.
...
## Shared Rules
- Read `../shared-rules/STYLE-GUARDRAILS.md` before package-level outputs.
- Read `../shared-rules/ANTI-PATTERNS.md` before final delivery.
