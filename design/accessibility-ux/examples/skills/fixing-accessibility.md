...
Include before/after code for invalid form submit inside modal: add `aria-describedby`, summary anchor, focus restoration on close, escape behavior, and acceptance checks for Tab/Shift+Tab/Escape sequence.
