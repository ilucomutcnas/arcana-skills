...
Show reduced-motion CSS fallback, transform-only animation refactor, and acceptance checks for stable focus target, preserved scroll position, and latency under interaction bursts.
