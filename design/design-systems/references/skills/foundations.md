...
## When to Use
Use this skill when foundations decisions affect cross-team system consistency and release safety.
...
2. Apply decision rules and constraints for foundations.
