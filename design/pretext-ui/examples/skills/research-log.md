...
## Scenario
A maintainer executes an end-to-end **research-log** workflow for a Pretext change candidate and prepares review evidence.
...
## Example additions
Revisit shaping-heavy experiment: compare old hypothesis to current corpus/browser evidence, make decision table, recommend proceed/hold.
