...
## Scenario
A maintainer executes an end-to-end **architecture-review** workflow for a Pretext change candidate and prepares review evidence.
...
## Example additions
Review diff touching layout metadata and packaging exports.
Include risk table, required evidence list, approval/blocking comments, final recommendation.
